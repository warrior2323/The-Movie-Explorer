...
useEffect(()=>{fetch(`https://api.themoviedb.org/3/movie/popular?api_key=${apiKey}`)
...
useEffect(()=>{fetch(`https://api.themoviedb.org/3/discover/movie?api_key=${apiKey}&with_genres=53`)
    .then(response => response.json())
    .then(data => {
...
useEffect(()=>{fetch(`https://api.themoviedb.org/3/discover/movie?api_key=${apiKey}&with_genres=28`)
    .then(response => response.json())
    .then(data => {
        setThrillerMovie(thrillerMovie => data.results)
